Ext.define("Payreq.controller.PayreqprojecttmpAdjustController", {
    extend: 'Payreq.controller.PayreqController',
    viewClass: 'Payreq.view.PayreqprojecttmpAdjustView',
    ...
    afterAdd: function () {
        var me = this;
        var view = me.view;
        view.getCmp("fadPayReqHDto->reqType").sotValue("2");
