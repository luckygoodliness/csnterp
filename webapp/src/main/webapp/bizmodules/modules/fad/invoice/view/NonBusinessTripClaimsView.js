Ext.define('Invoice.view.NonBusinessTripClaimsView', {
    ...
    queryLayoutFile: 'nonBusinessTripClaims-query-layout.xml',
    editLayoutFile: 'nonBusinessTripClaims-edit-layout.xml',
    ...
    needSplitPage: true,
    workFlowDefinitionKey: 'Non_Prm_Businesstrip_Claims',
...
//        var invoiceMaterialGrid = me.getCmp("scmInvoiceMaterialDto");
        fadCashReqInvoiceGrid.doAddRow = function (model) {
            var nonBusinessTripController = Scdp.getActiveModule().controller;
            nonBusinessTripController.pickCashReq();
        };
