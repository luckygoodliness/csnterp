Ext.define("FadReport.controller.PrmBillingMoneyController", {
    extend: 'Scdp.mvc.AbstractReportController',
    viewClass: 'FadReport.view.PrmBillingMoneyView',
    queryAction: 'prm_billing_money-query',
    extraEvents: [
    ...
    doReturn: function () {
        var menuCode = "ERP_PRM_BILLING_MONEY";
