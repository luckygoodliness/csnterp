Ext.define('FadReport.view.OperateReport5View', {
    ...
    afterInit: function () {
        ...
        if (Scdp.ObjUtil.isEmpty(me.getCmp("month").getValue())) {
            //me.getCmp("month").sotValue(Erp.Util.getCurrentMonthForInt());
            me.getCmp("month").sotValue(13);
