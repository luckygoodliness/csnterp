Ext.define('FadReport.view.VWBudgetDetailView', {
    ...
    afterInit: function () {
        ...
        /*var departMent = Scdp.CacheUtil.get(Scdp.Const.USER_DEPARTMENT_NAME);
         ...
         me.getCmp("conditionToolbar->btnMonitorLaborCostAndOtherShareExpense").setVisible(false);
