Ext.define("FadReport.controller.PrmReceiptsFadInvoicePaymentMoneyController", {
    extend: 'Scdp.mvc.AbstractReportController',
    viewClass: 'FadReport.view.PrmReceiptsFadInvoicePaymentMoneyView',
    queryAction: 'prm_receipts_fad_invoice_payment_money-query',
    extraEvents: [
    ...
    doReturn: function () {
        var menuCode = "ERP_PRM_RECEIPTS_FAD_INVOICE_PAYMENT_MONEY";
