Ext.define('FadReport.view.OperateReport7View', {
    ...
    afterInit: function () {
        ...
        if (Scdp.ObjUtil.isEmpty(me.getCmp("countryCode").getValue())) {
            me.getCmp("countryCode").sotValue("CN");
            me.getCmp("countryCode").resetOriginalValue();
        }

        if (Scdp.ObjUtil.isEmpty(me.getCmp("year").getValue())) {
