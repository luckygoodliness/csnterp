Ext.define('OperateReport.view.OperateDepOperationsCompletionStatusReportView', {
    extend: 'Scdp.mvc.AbstractReportView',
    modulePath: 'com/csnt/scdp/bizmodules/modules/operate/report',
    cpHeight: 60,
    epHeight: 200,
    allowNullConditions: true,
    queryLayoutFile: 'operateDepOperationsCompletionStatusReport-query-layout.xml',
