Ext.define('Supplierinfochange.view.FadCustomToSupplierView', {
	...
	afterInit: function () {
		...
		if (departMent == "计划财务部") {
			me.getCmp("scmSupplierCDto->taxRegistrationNo").allowBlank = true;true
		...
		me.getCmp("conditionPanel->changeType").sotValue("1");
	}
});