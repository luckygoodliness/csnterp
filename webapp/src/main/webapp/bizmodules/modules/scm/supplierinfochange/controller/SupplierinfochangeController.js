Ext.define("Supplierinfochange.controller.SupplierinfochangeController", {
    extend: 'Scdp.mvc.AbstractCrudController',
    viewClass: 'Supplierinfochange.view.SupplierinfochangeView',
        ...
        var callBack = function (subView) {
            ...
            if (selectedRecords.length >= 1) {
                ...
                Scdp.doAction("supplierinfochange-supplierinfochange", postData, function (result) {
                    ...
                    view.getCmp("scmSupplierCDto->changeType").sotValue("0");
    ...
    afterAdd: function () {
        ...
        me.view.getCmp("scmSupplierCDto->supplierGenre").sotValue("1");
