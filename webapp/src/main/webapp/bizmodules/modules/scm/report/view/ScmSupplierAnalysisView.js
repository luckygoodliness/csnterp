Ext.define('ScmReport.view.ScmSupplierAnalysisView', {
    extend: 'Scdp.mvc.AbstractReportView',
    modulePath: 'com/csnt/scdp/bizmodules/modules/scm/report',
    cpHeight: 80,
    epHeight: 200,
    allowNullConditions: true,
    queryLayoutFile: 'scmSupplierAnalysis-query-layout.xml',
    ...
    afterInit: function () {
        ...
        /*me.getCmp("dateStart").sotValue(Erp.Util.getCurrentYear() + "-" + Erp.Util.getCurrentMonth() + "-01 00:00:00");
         me.getCmp("dateOver").sotValue(Erp.Util.getDateForStandard(null) + " 23:59:59");

         me.getCmp("dateStartHidden").sotValue(Erp.Util.getDateTimeForStandard(me.getCmp("dateStart").getValue()));
         me.getCmp("dateOverHidden").sotValue(Erp.Util.getDateTimeForStandard(me.getCmp("dateOver").getValue()));*/
