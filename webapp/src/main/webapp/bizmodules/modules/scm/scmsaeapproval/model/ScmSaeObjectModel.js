Ext.define("Scmsaeapproval.model.ScmSaeObjectModel", {
...
fields: ['uuid','companyCode','companyName','departmentCode','createBy','createTime','updateBy',
    ...
    'supplierId','materialCode',{name: 'materialType', defaultValue: 0},'comprehensive','item1',
    'item2','item3','item4','item5','item6','item7','item8','item9','item10','item11','item12',
    'item13','item14','item15','materialName','materialClassName']
	}
);