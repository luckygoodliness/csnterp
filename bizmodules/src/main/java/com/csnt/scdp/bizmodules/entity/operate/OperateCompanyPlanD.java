...
@Table(name = "OPERATE_COMPANY_PLAN_D")
public class OperateCompanyPlanD extends BasePojo {
    private String uuid;
    ...
    private String operateCompanyPlanCId;
    ...
    @Column(name = "OPERATE_COMPANY_PLAN_C_ID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getOperateCompanyPlanCId() {
        return operateCompanyPlanCId;
    }

    public void setOperateCompanyPlanCId(String operateCompanyPlanCId) {
        this.operateCompanyPlanCId = operateCompanyPlanCId;
    }

    @Column(name = "OBJECT_TYPE", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
