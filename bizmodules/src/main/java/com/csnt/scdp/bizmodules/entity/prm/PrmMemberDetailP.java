...
import com.csnt.scdp.bizmodules.entity.prm.common.PrmAbstractMemberDetailP;
...
@Table(name = "PRM_MEMBER_DETAIL_P")
public class PrmMemberDetailP extends BasePojo {
    ...
    @Column(name = "JOB_SHARE", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "ENTER_DATE", nullable = true, insertable = true, updatable = true, length = 0, precision = 0)
    ...
    @Column(name = "OUT_DATE", nullable = true, insertable = true, updatable = true, length = 0, precision = 0)
    ...
    @Column(name = "PERCENT", nullable = true, insertable = true, updatable = true, length = 6, precision = 3)
