...
import com.csnt.scdp.bizmodules.entity.fad.FadInvoiceMaterial;
...
/**
 * Created by xiezf on 2016/8/22.
 */
public class ImportInvoicesExcel extends ImportExcelHelper{

//    D:\project\ProZH\01_Source\bizmodules\src\main\java\com\csnt\scdp\bizmodules\modules\fad\invoice\template\ExcelStructure.xml
    private final static String EXCEL_STRUCTURE_XML_PATH = "com/csnt/scdp/bizmodules/modules/fad/invoice/template/ExcelStructure.xml";
    List<FadInvoiceMaterial> FadInvoiceMaterials;
    ...
    public Map doParseExcel(Map inMap) {
        ...
        FadInvoiceMaterials = new ArrayList<FadInvoiceMaterial>();
        try {
        ...
        rsMap.put("resData", FadInvoiceMaterials);
        return rsMap;
    }
    ...
    public void convertMapToPojo() {
        try {
            for (int i = 0; i < this.getListDatas().size(); i++) {
                FadInvoiceMaterial fadInvoiceMaterial = BeanFactory.getObject(FadInvoiceMaterial.class);
                BeanUtil.bean2Bean(this.getListDatas().get(i), fadInvoiceMaterial);
                FadInvoiceMaterials.add(fadInvoiceMaterial);
            }
        } catch (Exception e) {
