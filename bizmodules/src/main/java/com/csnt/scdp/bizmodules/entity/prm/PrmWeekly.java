...
@Table(name = "PRM_WEEKLY")
public class PrmWeekly extends BasePojo {
    private String uuid;
    private String prmProjectMainId;
    private Date weekleDate;
    ...
    @Column(name = "WEEKLE_DATE", nullable = true, insertable = true, updatable = true, length = 0, precision = 0)
    public Date getWeekleDate() {
        return weekleDate;
    }

    public void setWeekleDate(Date weekleDate) {
        this.weekleDate = weekleDate;
    }
