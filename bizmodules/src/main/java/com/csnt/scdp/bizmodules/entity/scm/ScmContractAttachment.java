...
/**
 * Description:  ScmContractAttachment
...
@Table(name = "SCM_CONTRACT_ATTACHMENT")
public class ScmContractAttachment extends BasePojo {
    private String uuid;
    ...
    @Column(name = "ATTACHMENT_TYPE", nullable = true, insertable = true, updatable = true, length = 2, precision = 0)
    ...
    @Column(name = "URL", nullable = true, insertable = true, updatable = true, length = 200, precision = 0)
