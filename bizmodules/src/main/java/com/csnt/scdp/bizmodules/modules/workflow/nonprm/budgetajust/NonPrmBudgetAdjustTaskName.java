 ...
 */
@Scope("singleton")
@Controller("non_prm_budget_adjustment-process-taskname")
@Transactional

public class NonPrmBudgetAdjustTaskName extends ERPWorkFlowBaseVariableCollectionAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        String sql = "select distinct so.org_name,h.year,h.state from non_project_budget_ajust_h h inner join scdp_org so on h.office_id = so.org_code where h.uuid=?";
