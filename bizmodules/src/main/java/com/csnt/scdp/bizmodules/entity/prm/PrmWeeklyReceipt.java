...
@Table(name = "PRM_WEEKLY_RECEIPT")
public class PrmWeeklyReceipt extends BasePojo {
    private String uuid;
    private String prmProjectMainId;
    private String prmWeeklyId;
    private String prmReceiptsId;
    ...
    @Column(name = "PRM_RECEIPTS_ID", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    public String getPrmReceiptsId() {
        return prmReceiptsId;
    }

    public void setPrmReceiptsId(String prmReceiptsId) {
        this.prmReceiptsId = prmReceiptsId;
    }
