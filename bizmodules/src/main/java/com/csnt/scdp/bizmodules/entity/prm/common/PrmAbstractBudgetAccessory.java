...
public class PrmAbstractBudgetAccessory extends BasePojo {
    private String uuid;
    ...
    @Column(name = "ACCESSORY_NAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "ACCESSORY_MODEL", nullable = true, insertable = true, updatable = true, length = 200, precision = 0)
