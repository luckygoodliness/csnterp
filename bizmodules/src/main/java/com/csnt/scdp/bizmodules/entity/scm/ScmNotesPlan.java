...
/**
 * Description:  ScmNotesPlan
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-11-30 13:22:43
 */

@javax.persistence.Entity
@Table(name = "SCM_NOTES_PLAN")
public class ScmNotesPlan extends BasePojo {
    private String uuid;
    ...
    @Column(name = "ISSUE_NUMBER", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "ISLOCK", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
