...
import com.csnt.scdp.bizmodules.modules.workflow.scm.supplierlimitchange.ScmSupplierLimitChangeStart;
 ...
 */
@Scope("singleton")
@Controller("scm_qualified_supplier-complete")
@Transactional

public class ScmQualifiedSupplierComplete extends ScmQualifiedSupplierStart {
    @Override
