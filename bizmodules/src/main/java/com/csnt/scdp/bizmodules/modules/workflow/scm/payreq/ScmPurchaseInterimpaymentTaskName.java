 ...
 */
@Scope("singleton")
@Controller("scm_purchasepaymentrequestinterimpayment-process-taskname")
@Transactional

public class ScmPurchaseInterimpaymentTaskName extends ERPWorkFlowBaseVariableCollectionAction {
