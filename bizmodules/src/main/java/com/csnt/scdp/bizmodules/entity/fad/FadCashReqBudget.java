...
/**
 * Description:  FadCashReqBudget
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-12-20 17:40:03
 */

@javax.persistence.Entity
@Table(name = "FAD_CASH_REQ_BUDGET")
public class FadCashReqBudget extends BasePojo {
    private String uuid;
    ...
    @Column(name = "BUDGET_SUBJECT_CODE", nullable = true, insertable = true, updatable = true, length = 200, precision = 0)
    ...
    @Column(name = "BUDGET_MONEY", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
