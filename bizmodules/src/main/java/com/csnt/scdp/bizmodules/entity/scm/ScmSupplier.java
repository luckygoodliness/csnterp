...
/**
 * Description:  ScmSupplier
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-12-04 13:44:17
 */

@javax.persistence.Entity
@Table(name = "SCM_SUPPLIER")
public class ScmSupplier extends BasePojo {
    private String uuid;
    ...
    @Column(name = "SIMPLE_NAME", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
