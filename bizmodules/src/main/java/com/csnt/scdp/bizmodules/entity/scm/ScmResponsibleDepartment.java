...
/**
 * Description:  ScmResponsibleDepartment
...
@Table(name = "SCM_RESPONSIBLE_DEPARTMENT")
public class ScmResponsibleDepartment extends BasePojo {
    private String uuid;
    ...
    @Column(name = "RESPONSIBLE_DEPARTMENT", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "ATTACHE", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
