...
import com.csnt.scdp.bizmodules.modules.workflow.scm.scmcontractchange.ScmContractChangeStart;
 ...
 */
@Scope("singleton")
@Controller("scm_purchase_change-complete")
@Transactional

public class ScmNewContractChangeComplete extends ScmContractChangeStart {
