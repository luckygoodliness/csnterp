...
@Table(name = "PRM_ARCHIVING")
public class PrmArchiving extends BasePojo {
    private String uuid;
    private String prmProjectMainId;
    private Date archivingDate;
    private Date archivingReqDate;
    ...
    @Column(name = "ARCHIVING_DATE", nullable = true, insertable = true, updatable = true, length = 0, precision = 0)
    ...
    @Column(name = "ARCHIVING_REQ_DATE", nullable = true, insertable = true, updatable = true, length = 0, precision = 0)
    public Date getArchivingReqDate() {
        return archivingReqDate;
    }

    public void setArchivingReqDate(Date archivingReqDate) {
        this.archivingReqDate = archivingReqDate;
    }
