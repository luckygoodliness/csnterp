...
/**
 * Description:  FadSupplier
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-12-10 13:41:19
 */

@javax.persistence.Entity
@Table(name = "FAD_SUPPLIER")
public class FadSupplier extends BasePojo {
    private String uuid;
    ...
    @Column(name = "OLD_NAME", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "ENGLISH_NAME", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "SIMPLE_NAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "INDUSTRY_TYPE", nullable = true, insertable = true, updatable = true, length = 20, precision = 0)
    ...
    @Column(name = "AP_NAME", nullable = true, insertable = true, updatable = true, length = 20, precision = 0)
    ...
    @Column(name = "CONTACT_INFO", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "URL", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "REGISTERED_ADDRESS", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "POSTCODE", nullable = true, insertable = true, updatable = true, length = 20, precision = 0)
    ...
    @Column(name = "BUSINESS_SCOPE", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "COMPANY_INTRODUCE", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "DEFAULT_LEVEL", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
    ...
    @Column(name = "DEFAULT_PROPERTY", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
