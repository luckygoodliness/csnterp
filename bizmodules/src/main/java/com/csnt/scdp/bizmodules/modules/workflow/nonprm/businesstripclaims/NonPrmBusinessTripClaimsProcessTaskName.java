 ...
 */
@Scope("singleton")
@Controller("non_prm_businesstrip_claims-process-taskname")
@Transactional

public class NonPrmBusinessTripClaimsProcessTaskName extends ERPWorkFlowBaseVariableCollectionAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        String sql = "select a.state,a.invoice_total_value,a.render_person,a.office_id,a.subject_code,a.invoice_req_no From fad_invoice a where a.uuid=?";
        ...
        if (ListUtil.isNotEmpty(lstResult)) {
            ...
            mapResult.put("name", stateDesc + "部门：" + orgName + ";报销人：" + userName + ";报销金额：" + temp.get("invoiceTotalValue"));
        }
        return mapResult;
    }
}
