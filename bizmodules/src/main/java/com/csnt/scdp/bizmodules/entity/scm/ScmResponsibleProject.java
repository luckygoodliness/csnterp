...
/**
 * Description:  ScmResponsibleProject
...
@Table(name = "SCM_RESPONSIBLE_PROJECT")
public class ScmResponsibleProject extends BasePojo {
    private String uuid;
    ...
    @Column(name = "RESPONSIBLE_PROJECT", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
