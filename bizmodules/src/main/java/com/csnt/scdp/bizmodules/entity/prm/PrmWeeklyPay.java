...
@Table(name = "PRM_WEEKLY_PAY")
public class PrmWeeklyPay extends BasePojo {
    private String uuid;
    private String prmProjectMainId;
    private String prmWeeklyId;
    private String prmPayReqId;
    ...
    @Column(name = "PRM_PAY_REQ_ID", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    public String getPrmPayReqId() {
        return prmPayReqId;
    }

    public void setPrmPayReqId(String prmPayReqId) {
        this.prmPayReqId = prmPayReqId;
    }

    @Column(name = "SCM_CONTRACT_ID", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
