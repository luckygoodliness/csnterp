 ...
 */
@Scope("singleton")
@Controller("prm_faily_claims-process-taskname")
@Transactional

public class PrmFailyClaimsProcessTaskName extends ERPWorkFlowBaseVariableCollectionAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (ListUtil.isNotEmpty(lstResult)) {
            ...
            try {
                ...
                throw new BizException("项目日常报销：流水号" + temp.get("invoiceReqNo") + "报销人或者报销部门未填");
            }
            String state = null;
