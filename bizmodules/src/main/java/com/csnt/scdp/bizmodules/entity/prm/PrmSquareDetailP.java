...
import com.csnt.scdp.bizmodules.entity.prm.common.PrmAbstractSquareDetailP;
...
@Table(name = "PRM_SQUARE_DETAIL_P")
public class PrmSquareDetailP extends BasePojo {
