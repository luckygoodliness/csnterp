...
/**
 * Description:  NonProjectIncome2
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-10-28 10:19:03
 */

@javax.persistence.Entity
@Table(name = "NON_PROJECT_INCOME2")
public class NonProjectIncome2 extends BasePojo {
    private String uuid;
    private String year;
    ...
    @Column(name = "SUBJECT", nullable = true, insertable = true, updatable = true, length = 100, precision = 0)
