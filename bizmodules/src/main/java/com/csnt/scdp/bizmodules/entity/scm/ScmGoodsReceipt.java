...
/**
 * Description:  ScmGoodsReceipt
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-09-27 16:37:03
 */

@javax.persistence.Entity
@Table(name = "SCM_GOODS_RECEIPT")
public class ScmGoodsReceipt extends BasePojo {
    private String uuid;
    ...
    @Column(name = "QUALITY", nullable = true, insertable = true, updatable = true, length = 200, precision = 0)
