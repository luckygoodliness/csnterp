...
@Scope("singleton")
@Controller("scmcontract-contractrevocation")
@Transactional
public class RevocationAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(RevocationAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (StringUtil.isNotEmpty(uuid)) {
            scmcontractManager.contractRevocation(uuid, fallbackReason);
