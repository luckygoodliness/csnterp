...
public class AssetCard extends BasePojo {
    private String uuid;
    ...
    private String unit;
    private String assetHandoverUuid;
    ...
    @Column(name = "END_USER_CODE", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "ASSET_HANDOVER_UUID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
