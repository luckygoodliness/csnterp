...
/**
 * Description:  ScmContractChange
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-12-15 21:05:16
 */

@javax.persistence.Entity
@Table(name = "SCM_CONTRACT_CHANGE")
public class ScmContractChange extends BasePojo {
    private String uuid;
    ...
    @Column(name = "ORIGINAL_VALUE", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
    ...
    @Column(name = "NEW_VALUE", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
    ...
    @Column(name = "CHANGE_REASON", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
    ...
    @Column(name = "CLOSE_CHANGE", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
    public String getCloseChange() {
        return closeChange;
    }

    public void setCloseChange(String closeChange) {
