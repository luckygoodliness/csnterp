...
/**
 * Description:  PrmUnknownReceipts
...
@Table(name = "PRM_UNKNOWN_RECEIPTS")
public class PrmUnknownReceipts extends BasePojo {
    private String uuid;
    ...
    @Column(name = "RECEIPT_NO", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
