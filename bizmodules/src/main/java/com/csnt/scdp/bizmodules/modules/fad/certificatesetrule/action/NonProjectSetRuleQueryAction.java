...
@Scope("singleton")
@Controller("nonprojectsetrule-query")
@Transactional
public class NonProjectSetRuleQueryAction extends CommonQueryAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(NonProjectSetRuleQueryAction.class);
