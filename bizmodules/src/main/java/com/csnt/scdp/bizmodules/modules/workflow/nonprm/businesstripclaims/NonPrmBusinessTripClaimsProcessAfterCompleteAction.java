 ...
 */
@Scope("singleton")
@Controller("non_prm_businesstrip_claims-after-fixed")
@Transactional

public class NonPrmBusinessTripClaimsProcessAfterCompleteAction extends ERPWorkFlowBaseVariableCollectionAction {
