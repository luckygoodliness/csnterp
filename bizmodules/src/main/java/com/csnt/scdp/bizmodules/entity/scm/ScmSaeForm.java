...
@Table(name = "SCM_SAE_FORM")
public class ScmSaeForm extends BasePojo {
    private String uuid;
    ...
    private String scmSaeObjectId;
    private String scmSaeTaskId;
    ...
    @Column(name = "SCM_SAE_OBJECT_ID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getScmSaeObjectId() {
        return scmSaeObjectId;
    }

    public void setScmSaeObjectId(String scmSaeObjectId) {
        this.scmSaeObjectId = scmSaeObjectId;
    }

    @Column(name = "SCM_SAE_TASK_ID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getScmSaeTaskId() {
        return scmSaeTaskId;
    }

    public void setScmSaeTaskId(String scmSaeTaskId) {
        this.scmSaeTaskId = scmSaeTaskId;
    }

    @Column(name = "USER_CODE", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
