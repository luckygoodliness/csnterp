...
@Scope("singleton")
@Controller("contractdetail-query")
@Transactional
public class ContratDetailQueryAction extends CommonQueryAction {
	private static ILogTracer tracer = LogTracerFactory.getInstance(ContratDetailQueryAction.class);
