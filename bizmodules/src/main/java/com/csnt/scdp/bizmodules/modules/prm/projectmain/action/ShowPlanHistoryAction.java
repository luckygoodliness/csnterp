...
@Scope("singleton")
@Controller("projectmain-show-plan-history")
@Transactional
public class ShowPlanHistoryAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(ShowPlanHistoryAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        Map out = projectmainManager.loadProjectPlanHistory(uuid);
        //Do After
        return out;
    }
}
