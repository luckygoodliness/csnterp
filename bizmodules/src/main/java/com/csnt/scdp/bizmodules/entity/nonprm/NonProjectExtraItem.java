...
/**
 * Description:  NonProjectExtraItem
 * Copyright: © 2015 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2015-10-26 19:08:19
 */

@javax.persistence.Entity
@Table(name = "NON_PROJECT_EXTRA_ITEM")
public class NonProjectExtraItem extends BasePojo {
    private String uuid;
    private String type;
    private String name;
    ...
    @Column(name = "TYPE", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
