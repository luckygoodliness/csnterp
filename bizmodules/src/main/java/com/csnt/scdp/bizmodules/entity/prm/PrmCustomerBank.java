...
@Table(name = "PRM_CUSTOMER_BANK")
public class PrmCustomerBank extends BasePojo {
    private String uuid;
    ...
    @Column(name = "BANK_CODE", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "BANK_NAME", nullable = true, insertable = true, updatable = true, length = 255, precision = 0)
    ...
    @Column(name = "BANK_NUMBER", nullable = true, insertable = true, updatable = true, length = 255, precision = 0)
