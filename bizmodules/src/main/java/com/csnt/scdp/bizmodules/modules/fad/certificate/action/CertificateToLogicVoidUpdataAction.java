 ...
 */
@Scope("singleton")
@Controller("certificate-certificateToLogicVoidUpdata")
@Transactional
public class CertificateToLogicVoidUpdataAction extends CommonLoadAction implements IAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        return certificateManager.certificateToLogicVoid(fadCertificateUuid, makerUuid);
    }
}
