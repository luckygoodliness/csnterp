...
import com.csnt.scdp.bizmodules.entity.prm.common.PrmAbstractBudgetRun;
...
@Table(name = "PRM_BUDGET_RUN")
public class PrmBudgetRun extends BasePojo {
    ...
    @Column(name = "FINANCIAL_SUBJECT_CODE", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
