...
@Scope("singleton")
@Controller("invoice-submit")
@Transactional
public class ButSubmitAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(ButSubmitAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (StringUtil.isNotEmpty(uuid)) {
            ...
            invoiceManager.changeStateToSubmitted(uuid);
