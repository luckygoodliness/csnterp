...
/**
 * Description:  PrmBudgetPrincipalC
...
@Table(name = "PRM_BUDGET_PRINCIPAL_C")
public class PrmBudgetPrincipalC extends BasePojo {
    ...
    @Column(name = "EQUIPMENT_MODEL", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
