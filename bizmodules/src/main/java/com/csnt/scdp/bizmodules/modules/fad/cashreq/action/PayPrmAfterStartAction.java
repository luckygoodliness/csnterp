 ...
 */
@Scope("singleton")
@Controller("prm_cash_request-after-start")
@Transactional
public class PayPrmAfterStartAction implements IAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        //暂时不做限制
//        if (fadCashReq.getSubjectName().equals("项目设计验收会务、设备厂验费")) {
//            if (ListUtil.isEmpty(ErpFileHelper.getCdmFileRelationByDataId(fadCashReq.getUuid()))) {
//                throw new BizException("费用内容为 项目设计验收会务、设备厂验费 ，必须上传预算附件！");
//            }
//        }
