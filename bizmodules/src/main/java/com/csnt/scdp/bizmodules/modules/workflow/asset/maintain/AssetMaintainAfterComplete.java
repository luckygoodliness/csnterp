 ...
 */
@Scope("singleton")
@Controller("asset_maintain-after-complete")
public class AssetMaintainAfterComplete implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(AssetMaintainAfterComplete.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (WorkFlowAttribute.STATUS_FIXED.equals(wfStatus)) {
            ...
            AssetCard assetCard = PersistenceFactory.getInstance().findByPK(AssetCard.class, certificateManager.isNullReturnEmpty(assetMaintain.getCardUuid()));
