...
@Scope("singleton")
@Controller("scm_supplier_limit-process-taskname")
@Transactional
public class ScmSupplierLimitTaskName extends ERPWorkFlowBaseVariableCollectionAction {
    @Override
    public Map perform(Map inMap) throws BizException, SysException {
        inMap.put("dto", "com.csnt.scdp.bizmodules.modules.scm.supplierlimit.dto.ScmSupplierLimitDto");
