...
@Table(name = "NON_PROJECT_BUDGET_H")
public class NonProjectBudgetH extends BasePojo {
    private String uuid;
    private String year;
    ...
    @Column(name = "BUDGET_TOTAL", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
