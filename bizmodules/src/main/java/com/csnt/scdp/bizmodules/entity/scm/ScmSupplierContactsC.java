...
/**
 * Description:  ScmSupplierContactsC
...
@Table(name = "SCM_SUPPLIER_CONTACTS_C")
public class ScmSupplierContactsC extends BasePojo {
    private String uuid;
    ...
    @Column(name = "MOBILE_PHONE", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
