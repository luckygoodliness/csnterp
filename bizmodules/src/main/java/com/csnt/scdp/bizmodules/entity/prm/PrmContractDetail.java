...
@Table(name = "PRM_CONTRACT_DETAIL")
public class PrmContractDetail extends BasePojo {
    ...
    @Column(name = "PRM_PROJECT_MAIN_ID", nullable = false, insertable = true, updatable = true, length = 32, precision
            = 0)
