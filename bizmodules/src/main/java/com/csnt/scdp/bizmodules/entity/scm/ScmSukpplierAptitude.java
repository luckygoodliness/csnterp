...
/**
 * Description:  ScmSukpplierAptitude
...
@Table(name = "SCM_SUKPPLIER_APTITUDE")
public class ScmSukpplierAptitude extends BasePojo {
    private String uuid;
    ...
    @Column(name = "APTITUDE_TYPE", nullable = true, insertable = true, updatable = true, length = 4, precision = 0)
