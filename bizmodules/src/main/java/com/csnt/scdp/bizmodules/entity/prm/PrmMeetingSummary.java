...
@Table(name = "PRM_MEETING_SUMMARY")
public class PrmMeetingSummary extends BasePojo {
    private String uuid;
    ...
    @Column(name = "MEETING_LOCATION", nullable = true, insertable = true, updatable = true, length = 10, precision = 0)
    ...
    @Column(name = "MEETING_PERSONS", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "WORK_PLAN", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
