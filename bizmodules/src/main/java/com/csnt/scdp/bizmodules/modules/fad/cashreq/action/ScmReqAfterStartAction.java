 ...
 */
@Scope("singleton")
@Controller("scm_purchasepaymentrequestcontract-after-start")
@Transactional
public class ScmReqAfterStartAction implements IAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (cashreqManager.checkWorkAction(cashreqManager.getFadCashReqbyUuid(businessKey), "submit")) {
            state = 1;//已提交
        } else {
