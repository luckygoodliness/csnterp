...
/**
 * Description:  NonProjectBudgetAjustC
...
@Table(name = "NON_PROJECT_BUDGET_AJUST_C")
public class NonProjectBudgetAjustC extends BasePojo {
    private String uuid;
    private String hid;
    private String financialSubjectCode;
    private BigDecimal orrigalBudgetAssigned;
    private BigDecimal budgetChanged;
    ...
    @Column(name = "BUDGET_CHANGED", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
    public BigDecimal getBudgetChanged() {
        return budgetChanged;
    }

    public void setBudgetChanged(BigDecimal budgetChanged) {
        this.budgetChanged = budgetChanged;
    }

    @Column(name = "CHANGED_REASON", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
