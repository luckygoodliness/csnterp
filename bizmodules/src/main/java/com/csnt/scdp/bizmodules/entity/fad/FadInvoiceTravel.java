...
@Table(name = "FAD_INVOICE_TRAVEL")
public class FadInvoiceTravel extends BasePojo {
    private String uuid;
    ...
    @Column(name = "INVOICE_NUM", nullable = true, insertable = true, updatable = true, length = 3, precision = 0)
    ...
    @Column(name = "APPROVED_MONEY", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
