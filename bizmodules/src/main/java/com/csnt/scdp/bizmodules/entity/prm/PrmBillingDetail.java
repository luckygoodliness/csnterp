...
@Table(name = "PRM_BILLING_DETAIL")
public class PrmBillingDetail extends BasePojo {
    private String uuid;
    private String prmBillingId;
    ...
    @Column(name = "PRM_BILLING_ID", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    public String getPrmBillingId() {
        return prmBillingId;
    }

    public void setPrmBillingId(String prmBillingId) {
        this.prmBillingId = prmBillingId;
    }

    @Column(name = "CONTENT", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "CONTENT_EN", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
