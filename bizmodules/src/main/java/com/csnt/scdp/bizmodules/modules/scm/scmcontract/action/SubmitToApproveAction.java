...
@Scope("singleton")
@Controller("scmcontract-submittoapprove")
@Transactional
public class SubmitToApproveAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(SubmitToApproveAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if(StringUtil.isNotEmpty(uuid)){
            scmcontractManager.submitToApprove(uuid);
