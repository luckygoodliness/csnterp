...
/**
 * Description:  PrmPurchasePackageRecord
...
@Table(name = "PRM_PURCHASE_PACKAGE_RECORD")
public class PrmPurchasePackageRecord extends BasePojo {
    private String uuid;
    private String prmPurchasePackageId;
    ...
    @Column(name = "PRM_PURCHASE_PACKAGE_ID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getPrmPurchasePackageId() {
        return prmPurchasePackageId;
    }

    public void setPrmPurchasePackageId(String prmPurchasePackageId) {
        this.prmPurchasePackageId = prmPurchasePackageId;
    }

    @Column(name = "REVISED_BY", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "REVISED_TIME", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "PACKAGE_NAME", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
