 ...
 */
@Scope("singleton")
@Controller("scm_purchasepaymentrequestadjustinterimpayment-process-taskname")
@Transactional

public class ScmPurchaseInterimpaymentAdjustTaskName extends ERPWorkFlowBaseVariableCollectionAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        mapResult.put("name", stateDesc + "申请名称：" + reqno);
        return mapResult;
    }
}
