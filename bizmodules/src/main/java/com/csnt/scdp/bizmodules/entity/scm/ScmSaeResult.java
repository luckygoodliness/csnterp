...
/**
 * Description:  ScmSaeResult
 * Copyright: © 2016 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2016-09-07 20:57:06
 */

@javax.persistence.Entity
@Table(name = "SCM_SAE_RESULT")
public class ScmSaeResult extends BasePojo {
    private String uuid;
    ...
    private BigDecimal comprehensiveY;
    private BigDecimal comprehensiveD;
    ...
    @Column(name = "COMPREHENSIVE_Y", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
    public BigDecimal getComprehensiveY() {
        return comprehensiveY;
    }

    public void setComprehensiveY(BigDecimal comprehensiveY) {
        this.comprehensiveY = comprehensiveY;
    }

    @Column(name = "COMPREHENSIVE_D", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
    public BigDecimal getComprehensiveD() {
        return comprehensiveD;
    }

    public void setComprehensiveD(BigDecimal comprehensiveD) {
        this.comprehensiveD = comprehensiveD;
    }

    @Column(name = "RATIO", nullable = true, insertable = true, updatable = true, length = 18, precision = 3)
