...
@Scope("singleton")
@Controller("notesplan-marktime")
@Transactional
public class MarkTimeAction extends CommonModifyAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(MarkTimeAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        return notesplanManager.markTime(inMap);
    }
}
