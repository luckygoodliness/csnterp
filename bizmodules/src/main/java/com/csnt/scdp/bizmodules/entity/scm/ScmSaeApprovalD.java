...
/**
 * Description:  ScmSaeApprovalD
 * Copyright: © 2016 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2016-08-30 19:12:34
 */

@javax.persistence.Entity
@Table(name = "SCM_SAE_APPROVAL_D")
public class ScmSaeApprovalD extends BasePojo {
    private String uuid;
    ...
    private String scmSaeApprovalId;
    ...
    @Column(name = "SCM_SAE_APPROVAL_ID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getScmSaeApprovalId() {
        return scmSaeApprovalId;
    }

    public void setScmSaeApprovalId(String scmSaeApprovalId) {
        this.scmSaeApprovalId = scmSaeApprovalId;
    }
