...
/**
 * Description:  PrmBudgetAccessory
...
@Table(name = "PRM_BUDGET_ACCESSORY")
public class PrmBudgetAccessory extends BasePojo {
    ...
    @Column(name = "ACCESSORY_NAME", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
    ...
    @Column(name = "ACCESSORY_MODEL", nullable = true, insertable = true, updatable = true, length = 500, precision = 0)
