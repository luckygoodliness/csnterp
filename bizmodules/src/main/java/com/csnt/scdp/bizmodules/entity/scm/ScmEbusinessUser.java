...
@Table(name = "SCM_EBUSINESS_USER")
public class ScmEbusinessUser extends BasePojo {
    private String uuid;
    ...
    @Column(name = "EBUSINESS_NAME", nullable = true, insertable = true, updatable = true, length = 200, precision = 0)
    ...
    @Column(name = "USER_CODE", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "CHARGE", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
