...
public class AssetHandover extends BasePojo {
    private String uuid;
    ...
    private String purchaseReqDetailUuid;
    private String purchaseReqNo;
    private String checkAcceptanceResult;
    ...
    @Column(name = "HANDOVER_NO", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    ...
    @Column(name = "HANDOVER_DATE", nullable = true, insertable = true, updatable = true, length = 0, precision = 0)
    ...
    @Column(name = "HANDOVER_SUPERVISOR", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    public String getHandoverSupervisor() {
        return handoverSupervisor;
    }

    public void setHandoverSupervisor(String handoverSupervisor) {
        this.handoverSupervisor = handoverSupervisor;
    }

    @Column(name = "PURCHASE_REQ_DETAIL_UUID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getPurchaseReqDetailUuid() {
        return purchaseReqDetailUuid;
    }

    public void setPurchaseReqDetailUuid(String purchaseReqDetailUuid) {
        this.purchaseReqDetailUuid = purchaseReqDetailUuid;
    }
    ...
    @Column(name = "CHECK_ACCEPTANCE_RESULT", nullable = true, insertable = true, updatable = true, length = 1024, precision = 0)
    public String getCheckAcceptanceResult() {
        return checkAcceptanceResult;
    }

    public void setCheckAcceptanceResult(String checkAcceptanceResult) {
        this.checkAcceptanceResult = checkAcceptanceResult;
    }
}