...
public class PrmAbstractContract extends BasePojo {
    private String uuid;
    ...
    @Column(name = "PROJECT_NAME", nullable = true, insertable = true, updatable = true, length = 50, precision = 0)
    ...
    @Column(name = "INNER_PURCHASE_REQ_ID", nullable = true, insertable = true, updatable = true, length = 32,
            precision = 0)
    ...
    @Column(name = "PROFIT_RATE", nullable = true, insertable = true, updatable = true, length = 18, precision = 2)
