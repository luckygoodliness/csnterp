...
/**
 * Description:  ScmResponsibleClass
...
@Table(name = "SCM_RESPONSIBLE_CLASS")
public class ScmResponsibleClass extends BasePojo {
    private String uuid;
    ...
    @Column(name = "RESPONSIBLE_CLASS", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
