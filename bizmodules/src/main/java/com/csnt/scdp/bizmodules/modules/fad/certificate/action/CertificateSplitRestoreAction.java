 ...
 */
@Scope("singleton")
@Controller("certificate-certificateSplitRestore")
@Transactional
public class CertificateSplitRestoreAction extends CommonLoadAction implements IAction {

    private static ILogTracer tracer = LogTracerFactory.getInstance(CertificateSplitRestoreAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        String returnValue = certificateManager.certificateSplitRestore(fadCertificateUuid);
