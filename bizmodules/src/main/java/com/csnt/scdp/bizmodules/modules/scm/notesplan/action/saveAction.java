...
@Scope("singleton")
@Controller("notesplan-save")
@Transactional
public class saveAction extends CommonModifyAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(saveAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        return notesplanManager.save(inMap);
    }
}
