...
@Scope("singleton")
@Controller("prm_main-after-start")
public class PrmMainSubmitAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(PrmMainSubmitAction.class);
