...
@Scope("singleton")
@Controller("prm_revise-after-complete")
public class PrmMainReviseApproveAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(PrmMainReviseApproveAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (WorkFlowAttribute.STATUS_FIXED.equals(wfStatus)) {
            ...
            if (prmprojectmaincManager.isProjectMainChangeDepartInner(uuid)) {
                prmprojectmaincManager.sendMsgToManager(uuid, prmProjectMainC.getProjectCode());
            }
