...
@Table(name = "SCM_SUPPLIER_BANK_C")
public class ScmSupplierBankC extends BasePojo {
    private String uuid;
    ...
    @Column(name = "BANK_NAME", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "BANK_ADDRESS", nullable = true, insertable = true, updatable = true, length = 250, precision = 0)
    ...
    @Column(name = "IS_EFFECT", nullable = true, insertable = true, updatable = true, length = 1, precision = 0)
