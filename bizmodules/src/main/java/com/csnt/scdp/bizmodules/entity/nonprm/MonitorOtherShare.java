...
/**
 * Description:  MonitorOtherShare
 * Copyright: © 2016 CSNT. All rights reserved.
 * Company:CSNT
 *
 * @author code-generator
 * @version 1.0
 * @timestamp 2016-04-08 16:32:17
 */

@javax.persistence.Entity
@Table(name = "MONITOR_OTHER_SHARE")
public class MonitorOtherShare extends BasePojo {
    private String uuid;
    private String monitorBaseId;
    ...
    @Column(name = "MONITOR_BASE_ID", nullable = true, insertable = true, updatable = true, length = 32, precision = 0)
    public String getMonitorBaseId() {
        return monitorBaseId;
    }

    public void setMonitorBaseId(String monitorBaseId) {
        this.monitorBaseId = monitorBaseId;
    }
