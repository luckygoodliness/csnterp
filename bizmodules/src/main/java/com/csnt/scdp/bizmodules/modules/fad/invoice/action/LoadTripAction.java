...
@Scope("singleton")
@Controller("tripinvoice-load")
@Transactional
public class LoadTripAction extends ErpLoadAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(LoadTripAction.class);
