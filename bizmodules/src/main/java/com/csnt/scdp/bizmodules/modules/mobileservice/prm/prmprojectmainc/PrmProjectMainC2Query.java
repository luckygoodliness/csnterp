 ...
 */
@Scope("singleton")
@Controller("mobile-terminal-query-prm_revise")
@Transactional
public class PrmProjectMainC2Query extends ERPMobileTerminalBaseVariableCollectionAction {
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        inMap.put("dto", ErpMobileDtoAttribute.definitionKey2Dto.get("Prm_Revise_Dto"));
        ...
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PROJECT_NAME,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getProjectName());//项目名称
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PROJECT_SHORT_NAME,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getProjectShortName());//项目简称
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PROJECT_CODE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getProjectCode());//项目代码
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.CONTRACTOR_OFFICE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getContractorOfficeDesc());//承担部门
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PROJECT_MANAGER,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getProjectManagerDesc());//项目负责人
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.SCHEDULED_BEGIN_DATE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getScheduledBeginDate() == null ? "" : DateUtil.formatDate(projectMainCDto.getScheduledBeginDate(), "yyyy-MM-dd"));//计划开始时间
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.SCHEDULED_END_DATE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getScheduledEndDate()==null?"": DateUtil.formatDate(projectMainCDto.getScheduledEndDate(), "yyyy-MM-dd"));//计划完成时间
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PROJECT_MONEY,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), MathUtil.formatDecimalToString(projectMainCDto.getProjectMoney(), "##,##0.00"));//合同运行额
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.COST_CONTROL_MONEY,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), MathUtil.formatDecimalToString(projectMainCDto.getCostControlMoney(), "##,##0.00"));//成本控制总额
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.TAX_TYPE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), FMCodeHelper.getDescByCode(projectMainCDto.getTaxType(), "CDM_TAX_TYPE"));//税款类别
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PRM_CODE_TYPE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH),  FMCodeHelper.getDescByCode(projectMainCDto.getPrmCodeType(), prmCodeType));//代号类型
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.IS_PRE_PROJECT,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH),  FMCodeHelper.getDescByCode(projectMainCDto.getIsPreProject()==null?"0":projectMainCDto.getIsPreProject().toString(), "IS_PRE_PROJECT"));//预立项
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.IS_MAJOR_PROJECT,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), FMCodeHelper.getDescByCode(projectMainCDto.getIsMajorProject()==null?"0":projectMainCDto.getIsMajorProject().toString(), "IS_PRE_PROJECT"));//是否重大立项项目
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.STATE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), FMCodeHelper.getDescByCode(projectMainCDto.getState(), "CDM_BILL_STATE"));//流程状态
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.ESTABLISH_DATE,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getEstablishDate() == null ? "" : DateUtil.formatDate(projectMainCDto.getEstablishDate(), "yyyy-MM-dd"));//立项时间
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.PROJECT_SERIAL_NO,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getProjectSerialNo());//立项序号
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.CONTRACT_DURATION,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getContractDuration());//工期
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.FUNDS_EXPLANATION,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getFundsExplanation());//立项经费说明
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.REMARK,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getRemark());//备注
        hostMap.put(ErpI18NHelper.englishToChinese(PrmProjectMainCAttribute.REVISE_REASON,
                ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), projectMainCDto.getReviseReason());//变更原因及内容
    ...
    private Map collectBudgetDetailCVariable(PrmProjectMainCDto projectMainCDto) {
        ...
        if (ListUtil.isNotEmpty(prmBudgetDetailCDtoList)) {
            for (PrmBudgetDetailCDto prmBudgetDetailCDto : prmBudgetDetailCDtoList) {
                ...
                map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.BUDGET_CODE, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), prmBudgetDetailCDto.getBudgetCode());//预算项代码
                if(prmBudgetDetailCDto.getContractMoney() != null) {
                    map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.CONTRACT_MONEY, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), MathUtil.formatDecimalToString(prmBudgetDetailCDto.getContractMoney(), "##,##0.00"));//原合同价
                }
                if(prmBudgetDetailCDto.getCostControlMoney() != null) {
                    map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.COST_CONTROL_MONEY, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), MathUtil.formatDecimalToString(prmBudgetDetailCDto.getCostControlMoney(), "##,##0.00"));//成本控制总额
                }
                if(prmBudgetDetailCDto.getVatAmount() != null) {
                    map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.VAT_AMOUNT, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), MathUtil.formatDecimalToString(prmBudgetDetailCDto.getVatAmount(), "##,##0.00"));//增值税
                }
                if(prmBudgetDetailCDto.getExcludingVatAmount() != null) {
                    map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.EXCLUDING_VAT_AMOUNT, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), MathUtil.formatDecimalToString(prmBudgetDetailCDto.getExcludingVatAmount(), "##,##0.00"));//税前成本
                }
                map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.EXPLANATION, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), prmBudgetDetailCDto.getExplanation());//说明
                map.put(ErpI18NHelper.englishToChinese(PrmBudgetDetailCAttribute.REMARK, ErpMobileModulePathAttribute.PRM_REVISE_MODULEPATH), prmBudgetDetailCDto.getRemark());//备注
        ...
        //todo 这些国际化需要以后再加
        resultMap.put("立项预算变更明细", prmBudgetDetailCInfo);
        return resultMap;
    }
}
