...
@Scope("singleton")
@Controller("invoice-sendtonc")
@Transactional
public class ButSendToNCAction implements IAction {
    private static ILogTracer tracer = LogTracerFactory.getInstance(ButSendToNCAction.class);
    ...
    public Map perform(Map inMap) throws BizException, SysException {
        ...
        if (StringUtil.isNotEmpty(uuid)) {
            invoiceManager.changeStateToSended(uuid);
